...
For compatibility for lower versions (up to 0.6.1) there is the option
rev-0-6. This option lets load the last offical released version of the 
hermpic package of the 0.6 version tree. I think it will be removed in 
the first release candidate of the nexti minor release step (version 0.8).

So port your schemas :-) 
...
The center option lets the package center the schemas on the page.

The box option lets the package draw a box around the schemas (not implemented yet).
